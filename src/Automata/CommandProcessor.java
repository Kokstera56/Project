...
public class CommandProcessor {
    ...
    public void start() {
        ...
        while (true) {
            ...
            if (command.equals("help")) {
                ...
                System.out.println("determinize <id>          - Creates deterministic automaton");
            ...
            } else if (command.startsWith("determinize ")) {
                ...
                if (automaton == null) {
                    ...
                    manager.determinizeAutomaton(automaton, newId);

                    System.out.println("Deterministic automaton created: " + newId);
    ...
    private boolean checkFileOpened() {

        if (!fileManager.hasOpenedFile()) {
            System.out.println("[ERROR] No opened file. Use: open <file>");
            return false;
        }
